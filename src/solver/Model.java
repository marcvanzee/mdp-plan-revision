...
public class Model {
    ...
    public State getRandomState() {
    	...
    	while (s == null) {
    		int x = r.nextInt(Parameters.maxX);
    		int y = r.nextInt(Parameters.maxY);
    		s = states[x][y];
    	}
   ...
   static Action infrequentFunExplorationPolicy(State pState, int explrThresh, double RPlus){
    ...
    HashMap<State,ArrayList<Double>> Q_Learn_To_Beyond_Convergence_And_Record_Objective_Valuations(){
        
        long countOfWhile = 0;
        
        HashMap<State,ArrayList<Double>> ret = new HashMap<State,ArrayList<Double>>();
    ...
    HashMap<State,ArrayList<Double>> Q_Learn_To_Beyond_Convergence_And_Record_Q_Val_Results()
    {
    	HashMap<State,ArrayList<Double>> ret = new HashMap<State,ArrayList<Double>>();
        long countOfWhile = 0;
